    ...
    <div class="container d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="register scrollto" href="login.php"><b>LOGIN</b></a></li>
        </ul>
    ...
    <div class="container position-relative">
      <div class="row gy-5" data-aos="fade-in">
        <div class="col-lg-6 order-2 order-lg-1 d-flex flex-column justify-content-center text-center text-lg-start">
          <h1>Your Gateway to <span>Career Opportunities with PHINMA UI</span></h1>
          <p>Join us today and take the next step 
            <br>towards your dream job.</p>
          <div class="d-flex justify-content-center justify-content-lg-start">
            <a href="reg.php" class="btn-find-job">Find a Job</a>
            <a href="reg.php" class="btn-post-job">Post a Job</a>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <main>
            ...
            <div class="section-title">
                ...
                <?php
            $get_data = "SELECT t1.id, t2.fname, t3.job_title, t3.location, t3.job_type, t3.salary, t3.date_posted
            FROM users t1
          ...
          <div class="col-xl-3 col-md-6 d-flex align-items-stretch mt-4 mt-md-0" data-aos="zoom-in" data-aos-delay="200">
            <div class="icon-box">
              ...
              <p>Considering changing careers? Explore the career reflections video series, which features graduates discussing their successful career journeys and illuminating ideas.</p>
                        ...
                        <?php } ?>
                               <div class ="btn"> 
                                 <a class="btn btn-primary py-3 px-5" href="reg.php">Browse More Jobs</a>
                               </div>
                    </main>
